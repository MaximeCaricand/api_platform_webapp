...
class RegionName
{
    public const codePostal_to_regionNom = array(
    ...
    static function getRegionName(string $codeDep): string{
        return RegionName::codePostal_to_regionNom[$codeDep];
    }

    static function getRandomRegion(): string {
        return RegionName::codePostal_to_regionNom[array_rand(RegionName::codePostal_to_regionNom, 1)];
    }
