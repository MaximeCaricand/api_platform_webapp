    ...
    useEffect(() => {
        const import_d3 = async () => {
            ...
            const svg = d3.select('svg')
                .attr("width", width)
                .attr("height", heigh);
            creationAxis(d3, svg, width, heigh, coordonneesBaseTransitionx, coordonneesBaseTransitiony);
        };
        import_d3();
    }, [])

    function creationAxis(d3, svg, width, heigh, coordonneesBaseTransitionx, coordonneesBaseTransitiony) {
